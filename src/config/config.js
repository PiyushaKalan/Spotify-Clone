...
import img19 from '../assets/images/img19.png'
 ...
 import musicFile1 from '../assets/media/song1.mp3'
 import musicFile2 from '../assets/media/song3.mp3'
 import musicFile3 from '../assets/media/song2.mp3'
 import musicFile4 from '../assets/media/song4.mp3'
 import musicFile5 from '../assets/media/song5.mp3'
 import musicFile6 from '../assets/media/song6.mp3'
 import musicFile7 from '../assets/media/song7.mp3'
 import musicFile8 from '../assets/media/song8.mp3'
...
import musicFile18 from '../assets/media/song18.mp3'
 export const TrendingCardData = [
  ...
  },
  {
    imgSrc: img18,
    heading:"Startboy",
    subHeading:"The Weeknd, Daft Punk",
  ...
  },
  {
    ...
    heading:"7 Rings",
    subHeading:"Ariana Grande",
    musicFile: musicFile13,
  },
  // {
  //   imgSrc: img14,
  //   heading:"Raat Ki Rani",
  ...
  // },
  {
    imgSrc: img15,
    heading:"One Kiss",
    subHeading:" Calvin Harris, Dua Lipa",
...
export const artistList =[
  {imgA: artist1, name:"Arijit Singh"},
  {imgA: artist2, name:"Pritam"},
  {imgA: artist3, name:"A.R.Rahman"},
  {imgA: artist4, name:"One Direction"},
  {imgA: artist5, name:"Taylor Swift"},
  {imgA: artist6, name:"Sabrina Carpenter"},
]